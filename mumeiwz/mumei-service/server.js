...
const API_DOCS = {
  ...
  data: {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/tools/data/number-to-chinese', desc: '数字转中文', params: [{ name: 'number', type: 'string', required: true }, { name: 'type', type: 'string', required: false }] },
      { method: 'POST', path: '/api/tools/data/date-calculator', desc: '日期计算器', params: [{ name: 'startDate', type: 'string', required: true }, { name: 'endDate', type: 'string', required: true }] },
      { method: 'POST', path: '/api/tools/data/random-number', desc: '随机数生成', params: [{ name: 'min', type: 'number', required: false }, { name: 'max', type: 'number', required: false }, { name: 'count', type: 'number', required: false }] },
  ...
  network: {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/tools/network/url-parser', desc: 'URL批量解析', params: [{ name: 'urls', type: 'array', required: true }] },
    ]
  },
  security: {
    title: '安全工具',
    endpoints: [
      ...
      { method: 'POST', path: '/api/tools/security/barcode-generate', desc: '条形码生成（专业版）', params: [{ name: 'text', type: 'string', required: true }] },
      { method: 'POST', path: '/api/tools/security/meta-generator', desc: 'SEO Meta标签生成（专业版）', params: [{ name: 'title', type: 'string', required: true }, { name: 'description', type: 'string', required: false }] },
      { method: 'POST', path: '/api/tools/security/hash-calc', desc: '哈希计算器', params: [{ name: 'text', type: 'string', required: true }] },
    ]
  },
  dev: {
    title: '开发工具',
